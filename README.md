# 👁️ DryEyeGuard: Trợ lý AI Bảo vệ Thị lực Toàn diện
...
*   **[🏗️ Kiến trúc Hệ thống (Architecture)](./docs/ARCHITECTURE.md)**: Giải thích chi tiết **Hệ thống Điểm (Score System)**, Sơ đồ **High-level Architecture** và Thuật toán **Adaptive 20-20-20**.
...
*   **Camera Assessment (30s)**: Đo lường thực tế tần suất chớp mắt (BPM) và tỷ lệ chớp mắt lỗi (Incomplete Blink Ratio).
